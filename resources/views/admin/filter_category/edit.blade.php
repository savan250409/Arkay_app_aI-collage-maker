                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="text-primary mb-0" style="font-weight: bold;">Edit Filter Category</h3>
                                <small class="text-muted">Update existing category</small>
                            </div>
                        </div>
                    ...
                    <form class="forms-sample" action="{{ route('filter-categories.update', $filterCategory->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Category Name"
                                value="{{ old('name', $filterCategory->name) }}" required>
                            @error('name')
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-flat form-check-primary">
                                <label class="form-check-label">
                                    <input type="checkbox" name="is_active" class="form-check-input" value="1" {{ old('is_active', $filterCategory->is_active ?? 1) ? 'checked' : '' }}>
                                    Active
