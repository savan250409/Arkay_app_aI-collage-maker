                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="text-primary mb-0" style="font-weight: bold;">Add New Filter</h3>
                    ...
                    <form class="forms-sample" action="{{ route('filters.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="filter_category_id" name="filter_category_id" required>
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('filter_category_id') == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" name="type" value="pro" {{ (old('type', 'pro') == 'pro') ? 'checked' : '' }}>
                                    Premium (Pro)
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.1" class="form-control" id="saturation" name="saturation"
                                        value="{{ old('saturation', 1.0) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.1" class="form-control" id="brightness" name="brightness"
                                        value="{{ old('brightness', 0) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.1" class="form-control" id="contrast" name="contrast"
                                        value="{{ old('contrast', 1.0) }}" required>
                                </div>
                            </div>
