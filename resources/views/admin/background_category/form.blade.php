            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                        ...
                        <a href="{{ session('bg_cat_list_url', route('background-categories.index')) }}" class="btn btn-light text-primary"
                    ...
                    <form class="forms-sample"
                        ...
                        <a href="{{ session('bg_cat_list_url', route('background-categories.index')) }}" class="btn btn-light">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
