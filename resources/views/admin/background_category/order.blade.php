            ...
            <div class="card border-0" style="box-shadow: none;">
                <div class="card-body p-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-3 mb-2">
                        ...
                        <a href="{{ route('background-categories.index') }}" class="text-muted" style="font-size: 1.5rem; text-decoration: none;">&times;</a>
                    </div>
        ...
        $(document).ready(function () {
            $("#sortable").sortable({
                ...
                update: function (event, ui) {
                    ...
                    $.ajax({
                        url: "{{ route('background-categories.update-order') }}",
                        type: 'POST',
                        data: {
                            order: order,
                            _token: '{{ csrf_token() }}'
